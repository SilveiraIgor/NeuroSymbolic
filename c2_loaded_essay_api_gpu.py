...
TOLERANCE = 20
ANOTADORA = "B"
nome_extra = f"_{ANOTADORA}_essay_addmult"
...
class Trainer():
  ...
  def train(self, n_epochs):
    ...
    nome_arquivo = f'performances_c2_{ANOTADORA}_essay_logic'+nome_extra+'.csv'
